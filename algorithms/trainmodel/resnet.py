...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor, flag: bool, flag_2: bool, logit=True, start_layer_idx=0) -> Tensor:
        ...
        if flag_2:
            ...
            results['output'] = nn.functional.log_softmax(x, dim=1)
            if logit:
                #print(x.size())
                results['logit'] = x
            #print(len(results))
    ...
    def forward(self, x: Tensor, flag: bool = False, flag_2: bool = False, logit=True, start_layer_idx=0) -> Tensor:
        return self._forward_impl(x, flag, flag_2, logit, start_layer_idx)
